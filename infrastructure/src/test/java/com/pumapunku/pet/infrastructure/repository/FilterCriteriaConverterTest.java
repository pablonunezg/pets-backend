...
/**
 * Tests unitarios para {@link FilterCriteriaConverter}.
 * Se mockea toda la JPA Criteria API para no requerir un contexto de persistencia.
 */
...
class FilterCriteriaConverterTest
{
    ...
    void isNotNull_invocaCbIsNotNull()
    {
