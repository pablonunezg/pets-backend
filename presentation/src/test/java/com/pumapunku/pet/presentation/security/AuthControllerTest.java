...
class AuthControllerTest
{
    ...
    @Test
    @DisplayName("login() con credenciales válidas debe retornar un token JWT")
    ...
    @Test
    @DisplayName("login() con credenciales inválidas debe propagar la excepción del AuthenticationManager")
