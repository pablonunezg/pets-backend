...
/**
 * Tests unitarios para los componentes de seguridad de la capa de presentación.
 */
...
class SecurityComponentsTest
{
    ...
    class UserTest
    {
        ...
        @Test
        @DisplayName("todos los flags de cuenta deben retornar true")
        void flagsCuenta_retornanTrue()
        {
            User user = User.builder().username("alice").password("pwd").role("USER").build();
        ...
        {
            User user = User.builder().username("bob").password("pwd").role("USER").build();
    ...
    class PasswordEncoderConfigTest
    {
        ...
        @Test
        @DisplayName("BCryptPasswordEncoder debe poder codificar y verificar contraseñas")
    ...
    class UserDetailsServiceImplTest
    {
        ...
        {
            UserDomain domain = new UserDomain(UUID.randomUUID(), "alice", "hashed", Role.ADMIN);
