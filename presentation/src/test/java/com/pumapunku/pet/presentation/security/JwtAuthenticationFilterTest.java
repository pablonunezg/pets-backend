...
/**
 * Tests unitarios para {@link JwtAuthenticationFilter}.
 */
...
class JwtAuthenticationFilterTest
{
    ...
    @Test
    @DisplayName("token válido debe establecer autenticación en SecurityContext")
    ...
    @Test
    @DisplayName("token con username null no debe establecer autenticación")
